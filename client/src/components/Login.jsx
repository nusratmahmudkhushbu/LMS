...
export default function Login() {
    ...
    <div className="d-flex align-items-center justify-content-center login">
        <div className="w-50 text-start" style={{backgroundColor: "white", padding: "40px", borderRadius: "10px"}}>
            ...
            <button className="btn btn-primary form-control mt-4" onClick={submit}>Login</button>
            <Link className="btn btn-link form-control mt-4" to='/signup'>Haven't signed up yet? Click here</Link>
        </div>
    </div>
    )
}