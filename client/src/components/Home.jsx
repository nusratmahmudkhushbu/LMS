        ...
        <div className="home">
            <div className="container w-50 pt-4">
                <div className="d-flex">
                    <input type="text" className="write-review" value={description} placeholder="write something" onChange={handleDescriptionChange} />
                    <button className="post-button" onClick={addReview}>Post</button>
                </div>
                <hr />
                {hasReviews &&
