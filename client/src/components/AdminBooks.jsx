                        ...
                        books.map(
                            book => (
                                <tr key={book.book_id}>
                                    ...
                                    <td>{book.year}</td>
                                    <td>{book.genre}</td>
                                    <button className="btn btn-success px-3 mx-2 mb-2" onClick={() => handleEdit(book)}>Edit</button>
                                    <button className="btn btn-warning mb-2" onClick={() => handleDelete(book.book_id)}>Delete</button>
                                </tr>
                            )
                        )
                    }
