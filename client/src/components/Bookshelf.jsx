    ...
    return (
        <div className="my-books">
            <div className="container pt-4">
                <h2 className="text-start" style={{color: "white"}}>My Bookshelf</h2>
                        ...
                        books.map(
                            book => (
                                <div className="col-12 col-md-2 m-1" key={book.book_id} style={{ backgroundColor: "#e5e5e5" }}>
                                    ...
                                    <p>{book.title}</p>
                                    <button className="btn btn-outline-success form-control mb-2" onClick={() => handleRemove(book.book_id)}>Remove</button>
